...
public class drinklist  {
    ...
    public List<booklist.Doc> getDocs() {
        return docs;
    }

    public void setDocs(List<booklist.Doc> docs) {
        this.docs = docs;
    }

    private List<booklist.Doc> docs;
     private int idDrink;
  ...
  private String strCategory;
    ...
    private String strInstrInstructionsZH_HANS ;
    ...
    public String getStrInstrInstructionsZH_HANS() {
        return strInstrInstructionsZH_HANS;
    }

    public void setStrInstrInstructionsZH_HANS(String strInstrInstructionsZH_HANS) {
        this.strInstrInstructionsZH_HANS = strInstrInstructionsZH_HANS;
    }
